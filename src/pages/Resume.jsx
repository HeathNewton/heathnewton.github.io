  ...
  return (
    <main id="resume">
      <div className="main-inner">
        ...
        <ul className="quals" role="list">
          <li>
            1995 | Victoria University of Wellington | Diploma of Library and
            Information Studies
          </li>
        ...
        <div className="grid employment-grid">
          <div className="grid__item">
            ...
            <ul className="nobm">
              ...
              <li>
                Developed new page types and components from supplied designs
              </li>
              <li>
                Technologies used:
                <ul>
        ...
        <ul className="prev-employment" role="list">
          ...
          <li>
            April 1991 - September 1997 | Ministry of Commerce | Acquisitions
            Librarian
          </li>
          <li>
            August 1986 - April 1991 | Dept of Trade and Industry / Ministry of
            Commerce | Circulation Assistant
          </li>
        </ul>
      </div>
    </main>
