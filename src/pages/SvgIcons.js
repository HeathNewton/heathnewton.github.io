	    ...
	    return (
	    	<main id={"project-" + project} role="main" className="main project">
	    		<div className="main-inner">
	    			<ProjectHeading item={project} title="SVG Icon Sprite" org="New Zealand Post" dates="February 2016 - July 2018" desc="Establishing an SVG icon system using the SVG Sprite technique." />
